...
var PeriodicalExecuter = Class.create({
  initialize: function(callback, freq) {
  ...
  registerCallback: function() {
    this.timer = setInterval(this.onTimerEvent.bind(this), this.freq * 1000);
  },
...
Ajax.PeriodicalUpdater = Class.create(Ajax.Base, {
  ...
  updateComplete: function(response) {
    ...
    this.timer = this.onTimerEvent.bind(this).delay(this.decay * this.freq);
  },
...
Abstract.TimedObserver = Class.create(PeriodicalExecuter, {
  initialize: function($super, element, freq, callback) {
    $super(callback, freq);
    this.element   = $(element);
